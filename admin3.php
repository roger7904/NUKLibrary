...
$link = mysqli_connect( 
    ...
    echo"<tr bgcolor='#f5f290'>"."<td>"."編號"."</td>"."<td>"."書名"."</td>"."<td>"."作者"."</td>"."<td>"."出版社"."</td>"."<td>"."圖片"."</td><td>"."預約者帳號"."</td><td>"."預約者mail"."</td></tr>";
        if ( $result = mysqli_query($link, $sql) ) {
            while( $row = mysqli_fetch_assoc($result) ){ 
                echo"<tr>"."<td>".$row["reserveno"]."</td>"."<td>".$row["reservename"]."</td>"."<td>".$row["reserveauthor"]."</td>"."<td>".$row["reservebookfrom"]."</td>"."<td>".'<img src="'.$row["reserveurl"].'" />'."</td><td>".$row["reserveaccount"]."</td><td>".$row["reservemail"]."</td></tr>";
        }
    }
?>