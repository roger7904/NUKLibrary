...
<div class="title">
    ...
    <div class="QA">
        <h2><a href="commonproblem.php">所有留言</a></h2>
    </div>
    <div class="question">
...
<?php
    ...
    $link = mysqli_connect( 
        ...
        $account=$_COOKIE["user"];
        $sql="SELECT * FROM ask where askaccount='$account'"; 
        ...
        echo"<tr bgcolor='#f5f290'>"."<td>"."我的帳號"."</td>"."<td>"."我"."</td>"."<td>"."主題"."</td>"."<td>"."內容"."</td>"."<td>"."提問時間"."</td>"."<td>"."管理者回覆"."</td>"."</tr>";
