...
<?php
    ...
    $li=$_GET["li"];
    $sql="select * from bulletin where li='$li'";
    if ( $result = mysqli_query($link, $sql) ) {
            ...
            echo "<tr bgcolor='#f5f290'><td>"."修改時間"."</td><td>"."佈告欄內容"."</td></tr>";
            echo "<tr><td>".$row["time"]."</td><td>".$row["li"]."</td></tr>";
        }
        echo "<div class=".'tableeeee'.">";
        echo "<form method=".'POST'." class='#'>";
        echo "<h2>輸入要改的佈告欄內容:</h2>"."<input type=".'text'." name=".'alterbulletin'."><br/><br/>";
        echo "<input type=".'submit'." value=".'修改'.">";
        echo "</form>";
        echo "</div>";
        $alterbulletin=$_POST["alterbulletin"];
        date_default_timezone_set("Asia/Taipei");
        $date=date("Y/m/d");

        if(isset($alterbulletin)){
        $sqlupdate="UPDATE bulletin SET time='$date',li='$alterbulletin' WHERE li='$li'";
